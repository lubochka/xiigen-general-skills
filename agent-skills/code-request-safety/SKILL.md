---
name: code-request-safety
description: "Check risk before code actions. Use before running commands, editing files, deleting files, moving data, or changing configuration."
---
