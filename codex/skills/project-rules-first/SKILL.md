---
name: project-rules-first
description: "Ensure project-specific rules are read before meaningful action. Use at task startup, before editing files, running commands, or adapting skills."
---
